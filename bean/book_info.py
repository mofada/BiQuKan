...
class BookInfo(object):
    def __init__(self, cover='', title='', author='', type='', status='', word_count='',
                 update_time='', update_chapter='', update_url='', description=''):
        # 书籍封面
        self.__cover = None
        # 书籍标题
        self.__title = None
    ...
    def set_description(self, description):
        self.__description = description.replace(u'作者', u'')
